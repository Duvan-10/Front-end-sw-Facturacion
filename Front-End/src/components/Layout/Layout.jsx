// Front-end/src/components/Layout/Layout.jsx (CORREGIDO)
...
    
    const handleLogout = () => {
        // 🚨 CAMBIO DE localStorage a sessionStorage para limpieza manual
        sessionStorage.removeItem('authToken'); 
        localStorage.removeItem('user'); // Si user no es sensible, podrías dejarlo en localStorage
